...
@section('shop-title', $product->name . ' Hosting Plans')
                ...
                <div class="row">
                    ...
                    @endif
                        ...
                        <div class="product-info">
                            ...
                            {{-- Product Features --}}
                            @if($product->metadata && isset($product->metadata['features']))
        ...
        <div class="card mt-3">
            ...
            <div class="card-body">
                ...
                <div class="related-product mb-3">
                    ...
                    <a href="{{ route('shop.product', $related) }}" class="btn btn-sm btn-outline-primary">
                        View Product
                    </a>
